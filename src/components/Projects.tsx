  ...
  return (
    <section id="projects" className="py-20 bg-white">
      <div className="container mx-auto px-6 max-w-5xl">
        <h2 className="text-2xl md:text-3xl font-bold mb-10 text-gray-900 text-center">Projects</h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project) => (
            <div
              key={project.title}
              className="bg-gray-50 border border-gray-200 rounded-lg p-6 flex flex-col shadow-sm"
            >
              ...
              <h3 className="font-mono font-semibold text-lg mb-3 text-gray-800">{project.title}</h3>
              ...
              <div className="flex flex-wrap gap-2">
                {project.technologies.map((tech) => (
                  <span
                    key={tech}
                    className="text-xs font-mono text-blue-700 bg-blue-100 px-2 py-1 rounded"
                  >
                    {tech}
                  </span>
                ))}
